...
<div>
    ...
    {#if settingsState.aiProvider !== 'managed' || controller.isAndroid}
    ...
    {#if controller.isAndroid}
        <div class="settings-row"><label for="hf-token">Hugging Face token</label><input id="hf-token" type="password" class="settings-field" bind:value={settingsState.huggingFaceToken} onchange={onSave} placeholder="hf_…" /></div>
    {/if}
    {#if controller.isAndroid}
